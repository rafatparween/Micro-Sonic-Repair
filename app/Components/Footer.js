      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-8 pb-4 border-b border-teal-700">
          <Link href="/" className="inline-block">
            <h2 className="text-[36px] font-bold text-white">
              <span className="text-white">123printsetupandhelp</span> 
              {/* <span className="text-white"> Printsetup </span>
              <span className="text-white">andhelp</span> */}
            </h2>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="flex items-center">
                ...
                <a
                  href="mailto:support@123printsetupandhelp.com"
        ...
        <div className="text-center pt-8 border-t border-[#1C8DCEED]">
          <p className="text-white">
            &copy; {new Date().getFullYear()} 123printsetupandhelp. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
