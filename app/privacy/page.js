        ...
        <>
            <div className="max-w-7xl mx-auto p-8 space-y-8 bg-gray-100 text-gray-800">
                ...
                <section>
                    ...
                    <p className="text-lg">
                        At <strong>123printsetupandhelp
                    ...
                    <p className="text-lg">
                        ...
                        <a href="mailto:support@123printsetupandhelp.com" className="text-blue-500 hover:underline">
                            support@123printsetupandhelp.com
                        </a>
                    </p>
                    <p className="text-lg">
                ...
                <section>
                    ...
                    <p className="text-lg">
                        We at <strong>123printsetupandhelp
</strong>, located at the World Wide Web as{" "}
                        <a href="http://123printsetupandhelp.com" className="text-blue-500 hover:underline">
                            www.123printsetupandhelp.com
                ...
                <section>
                    ...
                    <p className="text-lg">
                        If <strong>123printsetupandhelp
